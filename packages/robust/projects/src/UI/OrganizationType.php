 ...
 */
class OrganizationType extends BaseUI
{
    /**
     * @var array
     */
    public $columns = [
        ...
        'options' => [
            ...
            'delete' => [
                ...
                'params' => ['model' => 'Robust\Projects\Models\OrganizationType']
    ...
    {
        return route('admin.project.setting.edit', [$id, 'type' => 'organization_type']);
    }
