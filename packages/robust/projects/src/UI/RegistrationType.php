 ...
 */
class RegistrationType extends BaseUI
{
    /**
     * @var array
     */
    public $columns = [
        ...
        'options' => [
            ...
            'delete' => [
                ...
                'params' => ['model' => 'Robust\Projects\Models\RegistrationType']
    ...
    {
        return route('admin.project.setting.edit', [$id, 'type' => 'registration_type']);
    }
