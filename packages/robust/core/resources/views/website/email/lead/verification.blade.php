    ...
    <tr>
        <td style="border: none; border-bottom: 1px solid lightgrey;background-color: #F9F9F9;">
            <p style="padding: 10px 20px;">
                <span style="font-size: 15px;">Hi {{$member->firstname}},</span>
            </p>
            <p style="padding: 5px 20px;">
                <br>  You are warmly welcome in our RealEstate family.
                <br> Please click the button below to verify your email address.
                <br/>
                <br>
                <p style="text-align:center;"> <a href="{{$verificationUrl}}" style="margin-top: 12px;background:#1F7ABD;color:white;border:none;position:relative;height:90px;font-size:1.1em;font-weight: bolder;font-family: verdana;padding:10px 20px;cursor:pointer;border: 1;border-radius: 4px;outline:none;text-decoration:none;">Verify Email Address</a></p>
               <br/>
