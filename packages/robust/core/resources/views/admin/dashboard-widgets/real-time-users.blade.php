@set('analytics_helper',new Robust\Core\Helpers\AnalyticsHelper)
...
{{--                    <span class="pull-right grey-700 font-size-30 widget__widget-count">{{$analytics_helper->realTimeVisitors()}}</span>--}}
                </div>
